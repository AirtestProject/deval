...
import threading
import six
from deval.component.android.utils.constant import STFLIB, ORI_METHOD
...
from deval.utils.snippet import reg_cleanup, on_method_ready, ready_method
...
class Minicap(object):
    ...
    def get_frame(self, projection=None):
        ...
        raw_data = self.adb.raw_shell(
            self.CMD + " -n 'deval_minicap' -P %dx%d@%dx%d/%d -s" % params,
